...
namespace QiMenApi.Models.ReturnorderCreateModel
{
    public class ReturnorderCreateModel
    {

    }
    [XmlRoot("request")]
    public class ReturnorderCreateRequestModel
    {
    ...
    [XmlRoot("response")]
    public class ReturnorderCreateResponseModel
    {
        [XmlElement("flag")]

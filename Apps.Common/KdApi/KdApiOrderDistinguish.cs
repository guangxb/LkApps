...
namespace Apps.Common.KdApi
{
    public class KdApiOrderDistinguish
    {
        //电商ID
        //private string EBusinessID = "1284625";//勇哥账号
        private string EBusinessID = "1281577";
        
        //电商加密私钥，快递鸟提供，注意保管，不要泄漏
        //private string AppKey = "37c65654-b258-453a-a8cc-f0fb896f982d";//勇哥密钥
        ...
        /// </summary>
        /// <returns></returns>
        public string orderTracesSubByJson(string logisticCode)
        {
            //string requestData = "{'LogisticCode': '884873440435633547'}";

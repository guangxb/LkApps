...
namespace Apps.Common
{
    public static class Utils
    {
        ...
        #region 比较字符串是否相等（忽略大小写） + bool IsSame(this string strOri, string strCompare)
        /// <summary>
        /// 比较字符串是否相等（忽略大小写）
        /// </summary>
        ...
        public static bool IsSame(this string strOri, string strCompare)
        {
            if (string.IsNullOrEmpty(strOri) && string.IsNullOrEmpty(strCompare)) {
                return true;
            }else if (string.IsNullOrEmpty(strOri) || string.IsNullOrEmpty(strCompare))
                return false;
        ...
        #region 判断当前字符串是否为空 + bool IsNullOrEmpty(this string strOri)
        /// <summary>
        ///  判断当前字符串是否为空
        /// </summary>
        /// <param name="strOri">源字符串</param>

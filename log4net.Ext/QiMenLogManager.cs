...
namespace log4net.Ext
{
    public class QiMenLogManager
    {
        ...
        public static IQiMenPushLog Exists(string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public static IQiMenPushLog Exists(string domain, string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public static IQiMenPushLog Exists(Assembly assembly, string name)
        {
        ...
        public static IQiMenPushLog[] GetCurrentLoggers()
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public static IQiMenPushLog[] GetCurrentLoggers(string domain)
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public static IQiMenPushLog[] GetCurrentLoggers(Assembly assembly)
        {
        ...
        public static IQiMenPushLog GetLogger(string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IQiMenPushLog GetLogger(string domain, string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IQiMenPushLog GetLogger(Assembly assembly, string name)
        {
        ...
        /// <returns>the logger with the name specified</returns>
        public static IQiMenPushLog GetLogger(Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IQiMenPushLog GetLogger(string domain, Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IQiMenPushLog GetLogger(Assembly assembly, Type type)
        {
        ...
        private static IQiMenPushLog WrapLogger(ILogger logger)
        {
            return (IQiMenPushLog)s_wrapperMap.GetWrapper(logger);
        }
        ...
        private static IQiMenPushLog[] WrapLoggers(ILogger[] loggers)
        {
            IQiMenPushLog[] results = new IQiMenPushLog[loggers.Length];
        ...
        {
            return new QiMenPushLogImpl(logger);
        }

...
namespace Apps.Models
{
	...
	{
		public Apps.Models.SCV.SHIPPING.SHIPPING_CONTAINER_MODEL ToPOCO(){
			return new Apps.Models.SCV.SHIPPING.SHIPPING_CONTAINER_MODEL(){
				...
				OQC_BENCH=this.OQC_BENCH,
				OQCED=this.OQCED,
				OQC_USER=this.OQC_USER,
				OQC_START_DATE_TIME=this.OQC_START_DATE_TIME,
				OQC_END_DATE_TIME=this.OQC_END_DATE_TIME,

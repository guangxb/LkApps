...
{
	public partial class AR_RECEIPT_CONTAINER
	{
		public Apps.Models.SCV.AR.AR_RECEIPT_CONTAINER_MODEL ToPOCO(){
			return new Apps.Models.SCV.AR.AR_RECEIPT_CONTAINER_MODEL(){

...
{
	public partial class DELETED_SHIPMENT_HEADER
	{
		public Apps.Models.SCV.DELETED.DELETED_SHIPMENT_HEADER_MODEL ToPOCO(){
			return new Apps.Models.SCV.DELETED.DELETED_SHIPMENT_HEADER_MODEL(){

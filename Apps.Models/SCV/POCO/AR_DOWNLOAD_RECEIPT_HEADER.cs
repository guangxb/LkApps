...
{
	public partial class AR_DOWNLOAD_RECEIPT_HEADER
	{
		public Apps.Models.SCV.AR.AR_DOWNLOAD_RECEIPT_HEADER_MODEL ToPOCO(){
			return new Apps.Models.SCV.AR.AR_DOWNLOAD_RECEIPT_HEADER_MODEL(){

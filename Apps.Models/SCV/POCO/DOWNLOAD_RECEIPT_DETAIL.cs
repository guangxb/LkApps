...
{
	public partial class DOWNLOAD_RECEIPT_DETAIL
	{
		public Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_DETAIL_MODEL ToPOCO(){
			return new Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_DETAIL_MODEL(){

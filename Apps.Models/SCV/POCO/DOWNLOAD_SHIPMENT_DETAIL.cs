...
{
	public partial class DOWNLOAD_SHIPMENT_DETAIL
	{
		public Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_DETAIL_MODEL ToPOCO(){
			return new Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_DETAIL_MODEL(){

...
{
	public partial class RECEIPT_HEADER_TEMP
	{
		public Apps.Models.SCV.RECEIPT.RECEIPT_HEADER_TEMP_MODEL ToPOCO(){
			return new Apps.Models.SCV.RECEIPT.RECEIPT_HEADER_TEMP_MODEL(){

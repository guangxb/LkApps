...
{
	public partial class AR_DOWNLOAD_RECEIPT_DETAIL
	{
		public Apps.Models.SCV.AR.AR_DOWNLOAD_RECEIPT_DETAIL_MODEL ToPOCO(){
			return new Apps.Models.SCV.AR.AR_DOWNLOAD_RECEIPT_DETAIL_MODEL(){

...
{
	public partial class DOWNLOAD_SHIPMENT_HEADER
	{
		public Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_MODEL ToPOCO(){
			return new Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_MODEL(){

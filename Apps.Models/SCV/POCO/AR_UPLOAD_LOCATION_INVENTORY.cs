...
{
	public partial class AR_UPLOAD_LOCATION_INVENTORY
	{
		public Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL ToPOCO(){
			return new Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL(){

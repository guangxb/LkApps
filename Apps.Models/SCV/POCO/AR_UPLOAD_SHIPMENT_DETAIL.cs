...
{
	public partial class AR_UPLOAD_SHIPMENT_DETAIL
	{
		public Apps.Models.SCV.AR.AR_UPLOAD_SHIPMENT_DETAIL_MODEL ToPOCO(){
			return new Apps.Models.SCV.AR.AR_UPLOAD_SHIPMENT_DETAIL_MODEL(){

...
{
	public partial class AR_UPLOAD_SHIPPING_CONTAINER
	{
		public Apps.Models.SCV.AR.AR_UPLOAD_SHIPPING_CONTAINER_MODEL ToPOCO(){
			return new Apps.Models.SCV.AR.AR_UPLOAD_SHIPPING_CONTAINER_MODEL(){

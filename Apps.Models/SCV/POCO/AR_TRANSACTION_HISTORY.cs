...
{
	public partial class AR_TRANSACTION_HISTORY
	{
		public Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL ToPOCO(){
			return new Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL(){

...
{
	public partial class DOWNLOAD_SHIPMENTS_UPDATE
	{
		public Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENTS_UPDATE_MODEL ToPOCO(){
			return new Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENTS_UPDATE_MODEL(){

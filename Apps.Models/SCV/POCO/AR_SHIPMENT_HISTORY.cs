...
{
	public partial class AR_SHIPMENT_HISTORY
	{
		public Apps.Models.SCV.AR.AR_SHIPMENT_HISTORY_MODEL ToPOCO(){
			return new Apps.Models.SCV.AR.AR_SHIPMENT_HISTORY_MODEL(){

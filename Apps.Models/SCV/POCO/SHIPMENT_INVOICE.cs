...
namespace Apps.Models
{
	...
	{
		public Apps.Models.SCV.SHIPMENT.SHIPMENT_INVOICE_MODEL ToPOCO(){
			return new Apps.Models.SCV.SHIPMENT.SHIPMENT_INVOICE_MODEL(){
								INTERNAL_INVOICE_ID=this.INTERNAL_INVOICE_ID,
				INVOICE_TYPE=this.INVOICE_TYPE,
				INVOICE_HEADER=this.INVOICE_HEADER,
				INVOICE_CONTENT=this.INVOICE_CONTENT,
				AMOUNT=this.AMOUNT,
				INTERNAL_SHIPMENT_ID=this.INTERNAL_SHIPMENT_ID,

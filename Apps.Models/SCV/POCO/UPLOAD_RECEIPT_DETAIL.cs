...
{
	public partial class UPLOAD_RECEIPT_DETAIL
	{
		public Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_DETAIL_MODEL ToPOCO(){
			return new Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_DETAIL_MODEL(){

...
{
	public partial class UPLOAD_RECEIPT_CONTAINER
	{
		public Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_CONTAINER_MODEL ToPOCO(){
			return new Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_CONTAINER_MODEL(){

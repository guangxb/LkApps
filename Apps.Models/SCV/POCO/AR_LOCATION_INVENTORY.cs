...
{
	public partial class AR_LOCATION_INVENTORY
	{
		public Apps.Models.SCV.AR.AR_LOCATION_INVENTORY_MODEL ToPOCO(){
			return new Apps.Models.SCV.AR.AR_LOCATION_INVENTORY_MODEL(){

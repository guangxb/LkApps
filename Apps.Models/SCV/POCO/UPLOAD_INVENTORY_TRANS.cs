...
{
	public partial class UPLOAD_INVENTORY_TRANS
	{
		public Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL ToPOCO(){
			return new Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL(){

...
{
	public partial class SHIPPING_CART_HEADER
	{
		public Apps.Models.SCV.SHIPPING.SHIPPING_CART_HEADER_MODEL ToPOCO(){
			return new Apps.Models.SCV.SHIPPING.SHIPPING_CART_HEADER_MODEL(){

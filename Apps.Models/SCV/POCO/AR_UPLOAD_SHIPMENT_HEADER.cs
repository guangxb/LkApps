...
{
	public partial class AR_UPLOAD_SHIPMENT_HEADER
	{
		public Apps.Models.SCV.AR.AR_UPLOAD_SHIPMENT_HEADER_MODEL ToPOCO(){
			return new Apps.Models.SCV.AR.AR_UPLOAD_SHIPMENT_HEADER_MODEL(){

...
{
	public partial class UPLOAD_SHIPMENT_HEADER
	{
		public Apps.Models.SCV.UPLOAD.UPLOAD_SHIPMENT_HEADER_MODEL ToPOCO(){
			return new Apps.Models.SCV.UPLOAD.UPLOAD_SHIPMENT_HEADER_MODEL(){

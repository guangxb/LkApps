...
{
	public partial class UPLOAD_RECEIPT_HEADER
	{
		public Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_HEADER_MODEL ToPOCO(){
			return new Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_HEADER_MODEL(){

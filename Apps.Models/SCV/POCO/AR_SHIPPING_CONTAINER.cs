...
{
	public partial class AR_SHIPPING_CONTAINER
	{
		public Apps.Models.SCV.AR.AR_SHIPPING_CONTAINER_MODEL ToPOCO(){
			return new Apps.Models.SCV.AR.AR_SHIPPING_CONTAINER_MODEL(){

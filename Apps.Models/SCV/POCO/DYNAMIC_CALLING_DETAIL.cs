...
{
	public partial class DYNAMIC_CALLING_DETAIL
	{
		public Apps.Models.SCV.DYNAMIC.DYNAMIC_CALLING_DETAIL_MODEL ToPOCO(){
			return new Apps.Models.SCV.DYNAMIC.DYNAMIC_CALLING_DETAIL_MODEL(){

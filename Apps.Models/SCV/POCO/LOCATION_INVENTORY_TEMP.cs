...
{
	public partial class LOCATION_INVENTORY_TEMP
	{
		public Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL ToPOCO(){
			return new Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL(){

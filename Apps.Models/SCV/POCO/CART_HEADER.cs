...
namespace Apps.Models
{
	...
	{
		public Apps.Models.SCV.CART.CART_HEADER_MODEL ToPOCO(){
			return new Apps.Models.SCV.CART.CART_HEADER_MODEL(){
								INTERNAL_CART_HEADER_NUM=this.INTERNAL_CART_HEADER_NUM,
				CART_HEADER_ID=this.CART_HEADER_ID,
				MULTI_ROTE=this.MULTI_ROTE,

...
{
	public partial class AR_SHIPMENT_HEADER
	{
		public Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL ToPOCO(){
			return new Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL(){

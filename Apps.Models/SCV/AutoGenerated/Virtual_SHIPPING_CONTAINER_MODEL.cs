...
{
	public class Virtual_SHIPPING_CONTAINER_MODEL
	{
			...
			public virtual string OQC_BENCH { get; set; }
			public virtual string OQCED { get; set; }
			public virtual string OQC_USER { get; set; }
			public virtual Nullable<System.DateTime> OQC_START_DATE_TIME { get; set; }
			public virtual Nullable<System.DateTime> OQC_END_DATE_TIME { get; set; }
			public virtual string SYSTEM_CREATED { get; set; }
			public virtual Nullable<decimal> SCANNED_QTY { get; set; }
		}
}

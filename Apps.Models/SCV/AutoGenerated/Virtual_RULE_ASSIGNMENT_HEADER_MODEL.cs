...
{
	public class Virtual_RULE_ASSIGNMENT_HEADER_MODEL
	{
			public virtual decimal INTERNAL_NUM { get; set; }
			public virtual string RULE_ASSIGN_NAME { get; set; }
			public virtual string RULE_ASSIGN_TYPE { get; set; }
			public virtual string WAREHOUSE { get; set; }
			public virtual string USER_STAMP { get; set; }
			public virtual Nullable<System.DateTime> DATE_TIME_STAMP { get; set; }
			public virtual string ALWASY_OVERRIDE { get; set; }

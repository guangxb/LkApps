...
using Apps.Models;
using System;
namespace Apps.Models.SCV.test
{
	public class Virtual_test_LOC_V_MODEL
	{
			...
			public virtual Nullable<decimal> ON_HAND_QTY { get; set; }
			public virtual Nullable<decimal> IN_TRANSIT_QTY { get; set; }

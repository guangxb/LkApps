...
{
	public class Virtual_REPLENISHMENT_REQUEST_MODEL
	{
			public virtual decimal INTERNAL_RPLN_REQ_NUM { get; set; }
			...
			public virtual string TO_PARENT_LPN { get; set; }
			public virtual string REPLENISHMENT_TYPE { get; set; }

...
{
	public class Virtual_UPLOAD_SHIPMENT_HISTORY_MODEL
	{
			...
			public virtual string UPLOAD_FLAG { get; set; }
			public virtual Nullable<System.DateTime> UPLOAD_TIME { get; set; }
			public virtual string UPLOAD_STATUS { get; set; }
			public virtual Nullable<System.DateTime> CALL_BACK_TIME { get; set; }
		}
}

...
{
	public class Virtual_AR_UPLOAD_RECEIPT_HEADER_SERVICE
	{
		...
		public Apps.IRepository.SCV.AR.IAR_UPLOAD_RECEIPT_HEADER_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.AR_UPLOAD_RECEIPT_HEADER;
			}
		}
		

		public virtual List<Apps.Models.SCV.AR.AR_UPLOAD_RECEIPT_HEADER_MODEL> GetList(Expression<Func<Apps.Models.AR_UPLOAD_RECEIPT_HEADER, bool>> where = null){
		
				IQueryable<Apps.Models.AR_UPLOAD_RECEIPT_HEADER> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.AR.AR_UPLOAD_RECEIPT_HEADER_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.AR_UPLOAD_RECEIPT_HEADER, bool>> where,Expression<Func<Apps.Models.AR_UPLOAD_RECEIPT_HEADER, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.AR_UPLOAD_RECEIPT_HEADER> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}
		...
		public virtual List<Apps.Models.SCV.AR.AR_UPLOAD_RECEIPT_HEADER_MODEL> CreateModelList(ref IQueryable<Apps.Models.AR_UPLOAD_RECEIPT_HEADER> queryData)
		{

			List<Apps.Models.SCV.AR.AR_UPLOAD_RECEIPT_HEADER_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.AR.AR_UPLOAD_RECEIPT_HEADER_MODEL
											  {

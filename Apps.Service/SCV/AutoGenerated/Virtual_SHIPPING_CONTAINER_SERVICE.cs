...
{
	public class Virtual_SHIPPING_CONTAINER_SERVICE
	{
		...
		public Apps.IRepository.SCV.SHIPPING.ISHIPPING_CONTAINER_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.SHIPPING_CONTAINER;
			}
		}
		

		public virtual List<Apps.Models.SCV.SHIPPING.SHIPPING_CONTAINER_MODEL> GetList(Expression<Func<Apps.Models.SHIPPING_CONTAINER, bool>> where = null){
		
				IQueryable<Apps.Models.SHIPPING_CONTAINER> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.SHIPPING.SHIPPING_CONTAINER_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.SHIPPING_CONTAINER, bool>> where,Expression<Func<Apps.Models.SHIPPING_CONTAINER, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.SHIPPING_CONTAINER> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}
		...
		public virtual List<Apps.Models.SCV.SHIPPING.SHIPPING_CONTAINER_MODEL> CreateModelList(ref IQueryable<Apps.Models.SHIPPING_CONTAINER> queryData)
		{

			List<Apps.Models.SCV.SHIPPING.SHIPPING_CONTAINER_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.SHIPPING.SHIPPING_CONTAINER_MODEL
											  {
													...
													OQC_BENCH = r.OQC_BENCH,
													OQCED = r.OQCED,
													OQC_USER = r.OQC_USER,
													OQC_START_DATE_TIME = r.OQC_START_DATE_TIME,
													OQC_END_DATE_TIME = r.OQC_END_DATE_TIME,
		...
		public virtual Apps.Models.SCV.SHIPPING.SHIPPING_CONTAINER_MODEL GetById(string id)
		{
			Apps.Models.SHIPPING_CONTAINER entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//SHIPPING_CONTAINER entity = m_Rep.GetById(id);
				Apps.Models.SCV.SHIPPING.SHIPPING_CONTAINER_MODEL model = new Apps.Models.SCV.SHIPPING.SHIPPING_CONTAINER_MODEL();
				...
				model.OQC_BENCH = entity.OQC_BENCH;
				model.OQCED = entity.OQCED;
				model.OQC_USER = entity.OQC_USER;
				model.OQC_START_DATE_TIME = entity.OQC_START_DATE_TIME;
				model.OQC_END_DATE_TIME = entity.OQC_END_DATE_TIME;
				model.SYSTEM_CREATED = entity.SYSTEM_CREATED;
				model.SCANNED_QTY = entity.SCANNED_QTY;

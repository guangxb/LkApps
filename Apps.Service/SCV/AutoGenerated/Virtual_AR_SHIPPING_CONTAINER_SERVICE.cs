...
{
	public class Virtual_AR_SHIPPING_CONTAINER_SERVICE
	{
		...
		public Apps.IRepository.SCV.AR.IAR_SHIPPING_CONTAINER_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.AR_SHIPPING_CONTAINER;
			}
		}
		

		public virtual List<Apps.Models.SCV.AR.AR_SHIPPING_CONTAINER_MODEL> GetList(Expression<Func<Apps.Models.AR_SHIPPING_CONTAINER, bool>> where = null){
		
				IQueryable<Apps.Models.AR_SHIPPING_CONTAINER> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.AR.AR_SHIPPING_CONTAINER_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.AR_SHIPPING_CONTAINER, bool>> where,Expression<Func<Apps.Models.AR_SHIPPING_CONTAINER, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.AR_SHIPPING_CONTAINER> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.AR.AR_SHIPPING_CONTAINER_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.AR_SHIPPING_CONTAINER, bool>> where = null)
		{

			IQueryable<Apps.Models.AR_SHIPPING_CONTAINER> queryData;
		...
		public virtual List<Apps.Models.SCV.AR.AR_SHIPPING_CONTAINER_MODEL> CreateModelList(ref IQueryable<Apps.Models.AR_SHIPPING_CONTAINER> queryData)
		{

			List<Apps.Models.SCV.AR.AR_SHIPPING_CONTAINER_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.AR.AR_SHIPPING_CONTAINER_MODEL
											  {

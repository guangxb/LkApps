...
{
	public class Virtual_DOWNLOAD_SHIPMENT_HEADER_SERVICE
	{
		...
		public Apps.IRepository.SCV.DOWNLOAD.IDOWNLOAD_SHIPMENT_HEADER_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.DOWNLOAD_SHIPMENT_HEADER;
			}
		}
		

		public virtual List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_MODEL> GetList(Expression<Func<Apps.Models.DOWNLOAD_SHIPMENT_HEADER, bool>> where = null){
		
				IQueryable<Apps.Models.DOWNLOAD_SHIPMENT_HEADER> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.DOWNLOAD_SHIPMENT_HEADER, bool>> where,Expression<Func<Apps.Models.DOWNLOAD_SHIPMENT_HEADER, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.DOWNLOAD_SHIPMENT_HEADER> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.DOWNLOAD_SHIPMENT_HEADER, bool>> where = null)
		{

			IQueryable<Apps.Models.DOWNLOAD_SHIPMENT_HEADER> queryData;
			...
			if (!string.IsNullOrWhiteSpace(queryStr))
			{
				queryData = m_Rep.GetList(where
								...
								|| a.TOTAL_VALUE.Contains(queryStr)
		...
		public virtual List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_MODEL> CreateModelList(ref IQueryable<Apps.Models.DOWNLOAD_SHIPMENT_HEADER> queryData)
		{

			List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_MODEL model)
		{
				...
				entity = new Apps.Models.DOWNLOAD_SHIPMENT_HEADER();
		...
		public virtual Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_MODEL GetById(string id)
		{
			Apps.Models.DOWNLOAD_SHIPMENT_HEADER entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//DOWNLOAD_SHIPMENT_HEADER entity = m_Rep.GetById(id);
				Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_MODEL model = new Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_MODEL();

...
{
	public class Virtual_RECEIPT_HEADER_TEMP_SERVICE
	{
		...
		public Apps.IRepository.SCV.RECEIPT.IRECEIPT_HEADER_TEMP_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.RECEIPT_HEADER_TEMP;
			}
		}
		

		public virtual List<Apps.Models.SCV.RECEIPT.RECEIPT_HEADER_TEMP_MODEL> GetList(Expression<Func<Apps.Models.RECEIPT_HEADER_TEMP, bool>> where = null){
		
				IQueryable<Apps.Models.RECEIPT_HEADER_TEMP> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.RECEIPT.RECEIPT_HEADER_TEMP_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.RECEIPT_HEADER_TEMP, bool>> where,Expression<Func<Apps.Models.RECEIPT_HEADER_TEMP, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.RECEIPT_HEADER_TEMP> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.RECEIPT.RECEIPT_HEADER_TEMP_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.RECEIPT_HEADER_TEMP, bool>> where = null)
		{

			IQueryable<Apps.Models.RECEIPT_HEADER_TEMP> queryData;
		...
		public virtual List<Apps.Models.SCV.RECEIPT.RECEIPT_HEADER_TEMP_MODEL> CreateModelList(ref IQueryable<Apps.Models.RECEIPT_HEADER_TEMP> queryData)
		{

			List<Apps.Models.SCV.RECEIPT.RECEIPT_HEADER_TEMP_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.RECEIPT.RECEIPT_HEADER_TEMP_MODEL
											  {

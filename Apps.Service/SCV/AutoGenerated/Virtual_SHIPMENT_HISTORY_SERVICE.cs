...
{
	public class Virtual_SHIPMENT_HISTORY_SERVICE
	{
		...
		public Apps.IRepository.SCV.SHIPMENT.ISHIPMENT_HISTORY_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.SHIPMENT_HISTORY;
			}
		}
		

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HISTORY_MODEL> GetList(Expression<Func<Apps.Models.SHIPMENT_HISTORY, bool>> where = null){
		
				IQueryable<Apps.Models.SHIPMENT_HISTORY> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HISTORY_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.SHIPMENT_HISTORY, bool>> where,Expression<Func<Apps.Models.SHIPMENT_HISTORY, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.SHIPMENT_HISTORY> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HISTORY_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.SHIPMENT_HISTORY, bool>> where = null)
		{

			IQueryable<Apps.Models.SHIPMENT_HISTORY> queryData;
		...
		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HISTORY_MODEL> CreateModelList(ref IQueryable<Apps.Models.SHIPMENT_HISTORY> queryData)
		{

			List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HISTORY_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.SHIPMENT.SHIPMENT_HISTORY_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.SHIPMENT.SHIPMENT_HISTORY_MODEL model)
		{
				Apps.Models.SHIPMENT_HISTORY entity = m_Rep.GetById(model.INTERNAL_NUM);
				if (entity != null)
				{
					errors.Add(Resource.PrimaryRepeat);
					return;
				}
				entity = new Apps.Models.SHIPMENT_HISTORY();
		...
		public virtual void Modify(ref ValidationErrors errors, Apps.Models.SCV.SHIPMENT.SHIPMENT_HISTORY_MODEL model,params string[] updateProperties)
		{
				Apps.Models.SHIPMENT_HISTORY entity = m_Rep.GetById(model.INTERNAL_NUM);
				if (entity == null)
				{
					...
					return;
						...
						Type type = typeof(Apps.Models.SCV.SHIPMENT.SHIPMENT_HISTORY_MODEL);
						Type typeE = typeof(Apps.Models.SHIPMENT_HISTORY);
		...
		public virtual Apps.Models.SCV.SHIPMENT.SHIPMENT_HISTORY_MODEL GetById(string id)
		{
			Apps.Models.SHIPMENT_HISTORY entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//SHIPMENT_HISTORY entity = m_Rep.GetById(id);
				Apps.Models.SCV.SHIPMENT.SHIPMENT_HISTORY_MODEL model = new Apps.Models.SCV.SHIPMENT.SHIPMENT_HISTORY_MODEL();

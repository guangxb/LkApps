...
{
	public class Virtual_SHIPMENT_DETAIL_SERVICE
	{
		...
		public Apps.IRepository.SCV.SHIPMENT.ISHIPMENT_DETAIL_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.SHIPMENT_DETAIL;
			}
		}
		

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_DETAIL_MODEL> GetList(Expression<Func<Apps.Models.SHIPMENT_DETAIL, bool>> where = null){
		
				IQueryable<Apps.Models.SHIPMENT_DETAIL> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_DETAIL_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.SHIPMENT_DETAIL, bool>> where,Expression<Func<Apps.Models.SHIPMENT_DETAIL, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.SHIPMENT_DETAIL> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_DETAIL_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.SHIPMENT_DETAIL, bool>> where = null)
		{

			IQueryable<Apps.Models.SHIPMENT_DETAIL> queryData;
		...
		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_DETAIL_MODEL> CreateModelList(ref IQueryable<Apps.Models.SHIPMENT_DETAIL> queryData)
		{

			List<Apps.Models.SCV.SHIPMENT.SHIPMENT_DETAIL_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.SHIPMENT.SHIPMENT_DETAIL_MODEL
											  {

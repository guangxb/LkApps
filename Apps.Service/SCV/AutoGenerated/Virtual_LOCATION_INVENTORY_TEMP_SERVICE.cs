...
{
	public class Virtual_LOCATION_INVENTORY_TEMP_SERVICE
	{
		...
		public Apps.IRepository.SCV.LOCATION.ILOCATION_INVENTORY_TEMP_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.LOCATION_INVENTORY_TEMP;
			}
		}
		

		public virtual List<Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL> GetList(Expression<Func<Apps.Models.LOCATION_INVENTORY_TEMP, bool>> where = null){
		
				IQueryable<Apps.Models.LOCATION_INVENTORY_TEMP> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.LOCATION_INVENTORY_TEMP, bool>> where,Expression<Func<Apps.Models.LOCATION_INVENTORY_TEMP, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.LOCATION_INVENTORY_TEMP> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.LOCATION_INVENTORY_TEMP, bool>> where = null)
		{

			IQueryable<Apps.Models.LOCATION_INVENTORY_TEMP> queryData;
		...
		public virtual List<Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL> CreateModelList(ref IQueryable<Apps.Models.LOCATION_INVENTORY_TEMP> queryData)
		{

			List<Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL model)
		{
				Apps.Models.LOCATION_INVENTORY_TEMP entity = m_Rep.GetById(model.INTERNAL_LOCATION_INV);
				if (entity != null)
				{
					errors.Add(Resource.PrimaryRepeat);
					return;
				}
				entity = new Apps.Models.LOCATION_INVENTORY_TEMP();
		...
		public virtual void Modify(ref ValidationErrors errors, Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL model,params string[] updateProperties)
		{
				Apps.Models.LOCATION_INVENTORY_TEMP entity = m_Rep.GetById(model.INTERNAL_LOCATION_INV);
				if (entity == null)
				{
					...
					return;
						...
						Type type = typeof(Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL);
						Type typeE = typeof(Apps.Models.LOCATION_INVENTORY_TEMP);
		...
		public virtual Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL GetById(string id)
		{
			Apps.Models.LOCATION_INVENTORY_TEMP entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//LOCATION_INVENTORY_TEMP entity = m_Rep.GetById(id);
				Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL model = new Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_TEMP_MODEL();

...
{
	public class Virtual_AR_RECEIPT_LOCATE_REQUEST_SERVICE
	{
		...
		public Apps.IRepository.SCV.AR.IAR_RECEIPT_LOCATE_REQUEST_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.AR_RECEIPT_LOCATE_REQUEST;
			}
		}
		

		public virtual List<Apps.Models.SCV.AR.AR_RECEIPT_LOCATE_REQUEST_MODEL> GetList(Expression<Func<Apps.Models.AR_RECEIPT_LOCATE_REQUEST, bool>> where = null){
		
				IQueryable<Apps.Models.AR_RECEIPT_LOCATE_REQUEST> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.AR.AR_RECEIPT_LOCATE_REQUEST_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.AR_RECEIPT_LOCATE_REQUEST, bool>> where,Expression<Func<Apps.Models.AR_RECEIPT_LOCATE_REQUEST, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.AR_RECEIPT_LOCATE_REQUEST> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.AR.AR_RECEIPT_LOCATE_REQUEST_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.AR_RECEIPT_LOCATE_REQUEST, bool>> where = null)
		{

			IQueryable<Apps.Models.AR_RECEIPT_LOCATE_REQUEST> queryData;
		...
		public virtual List<Apps.Models.SCV.AR.AR_RECEIPT_LOCATE_REQUEST_MODEL> CreateModelList(ref IQueryable<Apps.Models.AR_RECEIPT_LOCATE_REQUEST> queryData)
		{

			List<Apps.Models.SCV.AR.AR_RECEIPT_LOCATE_REQUEST_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.AR.AR_RECEIPT_LOCATE_REQUEST_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.AR.AR_RECEIPT_LOCATE_REQUEST_MODEL model)
		{
				...
				entity = new Apps.Models.AR_RECEIPT_LOCATE_REQUEST();
		...
		public virtual Apps.Models.SCV.AR.AR_RECEIPT_LOCATE_REQUEST_MODEL GetById(string id)
		{
			Apps.Models.AR_RECEIPT_LOCATE_REQUEST entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//AR_RECEIPT_LOCATE_REQUEST entity = m_Rep.GetById(id);
				Apps.Models.SCV.AR.AR_RECEIPT_LOCATE_REQUEST_MODEL model = new Apps.Models.SCV.AR.AR_RECEIPT_LOCATE_REQUEST_MODEL();

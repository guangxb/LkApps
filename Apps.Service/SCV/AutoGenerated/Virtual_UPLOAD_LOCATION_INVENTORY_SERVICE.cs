...
{
	public class Virtual_UPLOAD_LOCATION_INVENTORY_SERVICE
	{
		...
		public Apps.IRepository.SCV.UPLOAD.IUPLOAD_LOCATION_INVENTORY_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.UPLOAD_LOCATION_INVENTORY;
			}
		}
		

		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_LOCATION_INVENTORY_MODEL> GetList(Expression<Func<Apps.Models.UPLOAD_LOCATION_INVENTORY, bool>> where = null){
		
				IQueryable<Apps.Models.UPLOAD_LOCATION_INVENTORY> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_LOCATION_INVENTORY_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.UPLOAD_LOCATION_INVENTORY, bool>> where,Expression<Func<Apps.Models.UPLOAD_LOCATION_INVENTORY, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.UPLOAD_LOCATION_INVENTORY> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_LOCATION_INVENTORY_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.UPLOAD_LOCATION_INVENTORY, bool>> where = null)
		{

			IQueryable<Apps.Models.UPLOAD_LOCATION_INVENTORY> queryData;
		...
		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_LOCATION_INVENTORY_MODEL> CreateModelList(ref IQueryable<Apps.Models.UPLOAD_LOCATION_INVENTORY> queryData)
		{

			List<Apps.Models.SCV.UPLOAD.UPLOAD_LOCATION_INVENTORY_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.UPLOAD.UPLOAD_LOCATION_INVENTORY_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.UPLOAD.UPLOAD_LOCATION_INVENTORY_MODEL model)
		{
				Apps.Models.UPLOAD_LOCATION_INVENTORY entity = m_Rep.GetById(model.INTERNAL_LOCATION_INV);
				if (entity != null)
				{
					errors.Add(Resource.PrimaryRepeat);
					return;
				}
				entity = new Apps.Models.UPLOAD_LOCATION_INVENTORY();
		...
		public virtual void Modify(ref ValidationErrors errors, Apps.Models.SCV.UPLOAD.UPLOAD_LOCATION_INVENTORY_MODEL model,params string[] updateProperties)
		{
				Apps.Models.UPLOAD_LOCATION_INVENTORY entity = m_Rep.GetById(model.INTERNAL_LOCATION_INV);
				if (entity == null)
				{
					...
					return;
						...
						Type type = typeof(Apps.Models.SCV.UPLOAD.UPLOAD_LOCATION_INVENTORY_MODEL);
						Type typeE = typeof(Apps.Models.UPLOAD_LOCATION_INVENTORY);
		...
		public virtual Apps.Models.SCV.UPLOAD.UPLOAD_LOCATION_INVENTORY_MODEL GetById(string id)
		{
			Apps.Models.UPLOAD_LOCATION_INVENTORY entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//UPLOAD_LOCATION_INVENTORY entity = m_Rep.GetById(id);
				Apps.Models.SCV.UPLOAD.UPLOAD_LOCATION_INVENTORY_MODEL model = new Apps.Models.SCV.UPLOAD.UPLOAD_LOCATION_INVENTORY_MODEL();

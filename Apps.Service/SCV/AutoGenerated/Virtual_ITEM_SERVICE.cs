...
{
	public class Virtual_ITEM_SERVICE
	{
		...
		public Apps.IRepository.SCV.Sys.IITEM_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.ITEM;
			}
		}
		

		public virtual List<Apps.Models.SCV.Sys.ITEM_MODEL> GetList(Expression<Func<Apps.Models.ITEM, bool>> where = null){
		
				IQueryable<Apps.Models.ITEM> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.Sys.ITEM_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.ITEM, bool>> where,Expression<Func<Apps.Models.ITEM, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.ITEM> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.Sys.ITEM_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.ITEM, bool>> where = null)
		{

			IQueryable<Apps.Models.ITEM> queryData;
			
			if (!string.IsNullOrWhiteSpace(queryStr))
			{
				queryData = m_Rep.GetList(where
								
								,a=>a.ITEM1.Contains(queryStr)
								...
								|| a.MAINTAIN_STS.Contains(queryStr)
								);
			}else{
				queryData = m_Rep.GetList(where);
			}
		...
		public virtual List<Apps.Models.SCV.Sys.ITEM_MODEL> CreateModelList(ref IQueryable<Apps.Models.ITEM> queryData)
		{

			List<Apps.Models.SCV.Sys.ITEM_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.Sys.ITEM_MODEL
											  {
													INTERNAL_ITEM_NUM = r.INTERNAL_ITEM_NUM,
													ITEM1 = r.ITEM1,
													COMPANY = r.COMPANY,

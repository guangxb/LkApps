...
{
	public class Virtual_LOCATING_RULE_HEADER_SERVICE
	{
		...
		public Apps.IRepository.SCV.LOCATING.ILOCATING_RULE_HEADER_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.LOCATING_RULE_HEADER;
			}
		}
		

		public virtual List<Apps.Models.SCV.LOCATING.LOCATING_RULE_HEADER_MODEL> GetList(Expression<Func<Apps.Models.LOCATING_RULE_HEADER, bool>> where = null){
		
				IQueryable<Apps.Models.LOCATING_RULE_HEADER> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.LOCATING.LOCATING_RULE_HEADER_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.LOCATING_RULE_HEADER, bool>> where,Expression<Func<Apps.Models.LOCATING_RULE_HEADER, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.LOCATING_RULE_HEADER> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.LOCATING.LOCATING_RULE_HEADER_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.LOCATING_RULE_HEADER, bool>> where = null)
		{

			IQueryable<Apps.Models.LOCATING_RULE_HEADER> queryData;
		...
		public virtual List<Apps.Models.SCV.LOCATING.LOCATING_RULE_HEADER_MODEL> CreateModelList(ref IQueryable<Apps.Models.LOCATING_RULE_HEADER> queryData)
		{

			List<Apps.Models.SCV.LOCATING.LOCATING_RULE_HEADER_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.LOCATING.LOCATING_RULE_HEADER_MODEL
											  {

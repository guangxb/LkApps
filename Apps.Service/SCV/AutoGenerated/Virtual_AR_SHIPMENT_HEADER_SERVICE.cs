...
{
	public class Virtual_AR_SHIPMENT_HEADER_SERVICE
	{
		...
		public Apps.IRepository.SCV.AR.IAR_SHIPMENT_HEADER_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.AR_SHIPMENT_HEADER;
			}
		}
		

		public virtual List<Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL> GetList(Expression<Func<Apps.Models.AR_SHIPMENT_HEADER, bool>> where = null){
		
				IQueryable<Apps.Models.AR_SHIPMENT_HEADER> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.AR_SHIPMENT_HEADER, bool>> where,Expression<Func<Apps.Models.AR_SHIPMENT_HEADER, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.AR_SHIPMENT_HEADER> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.AR_SHIPMENT_HEADER, bool>> where = null)
		{

			IQueryable<Apps.Models.AR_SHIPMENT_HEADER> queryData;
		...
		public virtual List<Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL> CreateModelList(ref IQueryable<Apps.Models.AR_SHIPMENT_HEADER> queryData)
		{

			List<Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL model)
		{
				Apps.Models.AR_SHIPMENT_HEADER entity = m_Rep.GetById(model.INTERNAL_SHIPMENT_NUM);
				if (entity != null)
				{
					errors.Add(Resource.PrimaryRepeat);
					return;
				}
				entity = new Apps.Models.AR_SHIPMENT_HEADER();
		...
		public virtual void Modify(ref ValidationErrors errors, Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL model,params string[] updateProperties)
		{
				Apps.Models.AR_SHIPMENT_HEADER entity = m_Rep.GetById(model.INTERNAL_SHIPMENT_NUM);
				if (entity == null)
				{
					...
					return;
						...
						Type type = typeof(Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL);
						Type typeE = typeof(Apps.Models.AR_SHIPMENT_HEADER);
		...
		public virtual Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL GetById(string id)
		{
			Apps.Models.AR_SHIPMENT_HEADER entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//AR_SHIPMENT_HEADER entity = m_Rep.GetById(id);
				Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL model = new Apps.Models.SCV.AR.AR_SHIPMENT_HEADER_MODEL();

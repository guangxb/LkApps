...
{
	public class Virtual_DOWNLOAD_RECEIPT_HEADER_SERVICE
	{
		...
		public Apps.IRepository.SCV.DOWNLOAD.IDOWNLOAD_RECEIPT_HEADER_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.DOWNLOAD_RECEIPT_HEADER;
			}
		}
		

		public virtual List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_HEADER_MODEL> GetList(Expression<Func<Apps.Models.DOWNLOAD_RECEIPT_HEADER, bool>> where = null){
		
				IQueryable<Apps.Models.DOWNLOAD_RECEIPT_HEADER> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_HEADER_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.DOWNLOAD_RECEIPT_HEADER, bool>> where,Expression<Func<Apps.Models.DOWNLOAD_RECEIPT_HEADER, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.DOWNLOAD_RECEIPT_HEADER> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_HEADER_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.DOWNLOAD_RECEIPT_HEADER, bool>> where = null)
		{

			IQueryable<Apps.Models.DOWNLOAD_RECEIPT_HEADER> queryData;
		...
		public virtual List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_HEADER_MODEL> CreateModelList(ref IQueryable<Apps.Models.DOWNLOAD_RECEIPT_HEADER> queryData)
		{

			List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_HEADER_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_HEADER_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_HEADER_MODEL model)
		{
				Apps.Models.DOWNLOAD_RECEIPT_HEADER entity = m_Rep.GetById(model.INTERFACE_RECORD_ID);
				if (entity != null)
				{
					errors.Add(Resource.PrimaryRepeat);
					return;
				}
				entity = new Apps.Models.DOWNLOAD_RECEIPT_HEADER();
		...
		public virtual void Modify(ref ValidationErrors errors, Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_HEADER_MODEL model,params string[] updateProperties)
		{
				Apps.Models.DOWNLOAD_RECEIPT_HEADER entity = m_Rep.GetById(model.INTERFACE_RECORD_ID);
				if (entity == null)
				{
					...
					return;
						...
						Type type = typeof(Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_HEADER_MODEL);
						Type typeE = typeof(Apps.Models.DOWNLOAD_RECEIPT_HEADER);
		...
		public virtual Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_HEADER_MODEL GetById(string id)
		{
			Apps.Models.DOWNLOAD_RECEIPT_HEADER entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//DOWNLOAD_RECEIPT_HEADER entity = m_Rep.GetById(id);
				Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_HEADER_MODEL model = new Apps.Models.SCV.DOWNLOAD.DOWNLOAD_RECEIPT_HEADER_MODEL();

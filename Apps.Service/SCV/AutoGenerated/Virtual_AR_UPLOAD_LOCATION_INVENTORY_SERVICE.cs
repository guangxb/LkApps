...
{
	public class Virtual_AR_UPLOAD_LOCATION_INVENTORY_SERVICE
	{
		...
		public Apps.IRepository.SCV.AR.IAR_UPLOAD_LOCATION_INVENTORY_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.AR_UPLOAD_LOCATION_INVENTORY;
			}
		}
		

		public virtual List<Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL> GetList(Expression<Func<Apps.Models.AR_UPLOAD_LOCATION_INVENTORY, bool>> where = null){
		
				IQueryable<Apps.Models.AR_UPLOAD_LOCATION_INVENTORY> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.AR_UPLOAD_LOCATION_INVENTORY, bool>> where,Expression<Func<Apps.Models.AR_UPLOAD_LOCATION_INVENTORY, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.AR_UPLOAD_LOCATION_INVENTORY> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.AR_UPLOAD_LOCATION_INVENTORY, bool>> where = null)
		{

			IQueryable<Apps.Models.AR_UPLOAD_LOCATION_INVENTORY> queryData;
		...
		public virtual List<Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL> CreateModelList(ref IQueryable<Apps.Models.AR_UPLOAD_LOCATION_INVENTORY> queryData)
		{

			List<Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL model)
		{
				Apps.Models.AR_UPLOAD_LOCATION_INVENTORY entity = m_Rep.GetById(model.INTERNAL_LOCATION_INV);
				if (entity != null)
				{
					errors.Add(Resource.PrimaryRepeat);
					return;
				}
				entity = new Apps.Models.AR_UPLOAD_LOCATION_INVENTORY();
		...
		public virtual void Modify(ref ValidationErrors errors, Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL model,params string[] updateProperties)
		{
				Apps.Models.AR_UPLOAD_LOCATION_INVENTORY entity = m_Rep.GetById(model.INTERNAL_LOCATION_INV);
				if (entity == null)
				{
					...
					return;
						...
						Type type = typeof(Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL);
						Type typeE = typeof(Apps.Models.AR_UPLOAD_LOCATION_INVENTORY);
		...
		public virtual Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL GetById(string id)
		{
			Apps.Models.AR_UPLOAD_LOCATION_INVENTORY entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//AR_UPLOAD_LOCATION_INVENTORY entity = m_Rep.GetById(id);
				Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL model = new Apps.Models.SCV.AR.AR_UPLOAD_LOCATION_INVENTORY_MODEL();

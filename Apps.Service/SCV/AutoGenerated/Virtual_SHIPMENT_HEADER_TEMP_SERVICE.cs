...
{
	public class Virtual_SHIPMENT_HEADER_TEMP_SERVICE
	{
		...
		public Apps.IRepository.SCV.SHIPMENT.ISHIPMENT_HEADER_TEMP_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.SHIPMENT_HEADER_TEMP;
			}
		}
		

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP_MODEL> GetList(Expression<Func<Apps.Models.SHIPMENT_HEADER_TEMP, bool>> where = null){
		
				IQueryable<Apps.Models.SHIPMENT_HEADER_TEMP> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.SHIPMENT_HEADER_TEMP, bool>> where,Expression<Func<Apps.Models.SHIPMENT_HEADER_TEMP, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.SHIPMENT_HEADER_TEMP> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.SHIPMENT_HEADER_TEMP, bool>> where = null)
		{

			IQueryable<Apps.Models.SHIPMENT_HEADER_TEMP> queryData;
		...
		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP_MODEL> CreateModelList(ref IQueryable<Apps.Models.SHIPMENT_HEADER_TEMP> queryData)
		{

			List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP_MODEL
											  {

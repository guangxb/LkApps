...
{
	public class Virtual_SHIPPING_LOAD_SERVICE
	{
		...
		public Apps.IRepository.SCV.SHIPPING.ISHIPPING_LOAD_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.SHIPPING_LOAD;
			}
		}
		

		public virtual List<Apps.Models.SCV.SHIPPING.SHIPPING_LOAD_MODEL> GetList(Expression<Func<Apps.Models.SHIPPING_LOAD, bool>> where = null){
		
				IQueryable<Apps.Models.SHIPPING_LOAD> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.SHIPPING.SHIPPING_LOAD_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.SHIPPING_LOAD, bool>> where,Expression<Func<Apps.Models.SHIPPING_LOAD, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.SHIPPING_LOAD> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.SHIPPING.SHIPPING_LOAD_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.SHIPPING_LOAD, bool>> where = null)
		{

			IQueryable<Apps.Models.SHIPPING_LOAD> queryData;
		...
		public virtual List<Apps.Models.SCV.SHIPPING.SHIPPING_LOAD_MODEL> CreateModelList(ref IQueryable<Apps.Models.SHIPPING_LOAD> queryData)
		{

			List<Apps.Models.SCV.SHIPPING.SHIPPING_LOAD_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.SHIPPING.SHIPPING_LOAD_MODEL
											  {

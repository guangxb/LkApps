...
{
	public class Virtual_DOWNLOAD_SHIPMENT_HEADER_FAILED_SERVICE
	{
		...
		public Apps.IRepository.SCV.DOWNLOAD.IDOWNLOAD_SHIPMENT_HEADER_FAILED_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.DOWNLOAD_SHIPMENT_HEADER_FAILED;
			}
		}
		

		public virtual List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_FAILED_MODEL> GetList(Expression<Func<Apps.Models.DOWNLOAD_SHIPMENT_HEADER_FAILED, bool>> where = null){
		
				IQueryable<Apps.Models.DOWNLOAD_SHIPMENT_HEADER_FAILED> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_FAILED_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.DOWNLOAD_SHIPMENT_HEADER_FAILED, bool>> where,Expression<Func<Apps.Models.DOWNLOAD_SHIPMENT_HEADER_FAILED, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.DOWNLOAD_SHIPMENT_HEADER_FAILED> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_FAILED_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.DOWNLOAD_SHIPMENT_HEADER_FAILED, bool>> where = null)
		{

			IQueryable<Apps.Models.DOWNLOAD_SHIPMENT_HEADER_FAILED> queryData;
		...
		public virtual List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_FAILED_MODEL> CreateModelList(ref IQueryable<Apps.Models.DOWNLOAD_SHIPMENT_HEADER_FAILED> queryData)
		{

			List<Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_FAILED_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_FAILED_MODEL
											  {
		...
		public virtual Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_FAILED_MODEL GetById(string id)
		{
			Apps.Models.DOWNLOAD_SHIPMENT_HEADER_FAILED entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//DOWNLOAD_SHIPMENT_HEADER_FAILED entity = m_Rep.GetById(id);
				Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_FAILED_MODEL model = new Apps.Models.SCV.DOWNLOAD.DOWNLOAD_SHIPMENT_HEADER_FAILED_MODEL();

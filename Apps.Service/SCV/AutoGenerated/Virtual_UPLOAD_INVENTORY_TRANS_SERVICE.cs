...
{
	public class Virtual_UPLOAD_INVENTORY_TRANS_SERVICE
	{
		...
		public Apps.IRepository.SCV.UPLOAD.IUPLOAD_INVENTORY_TRANS_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.UPLOAD_INVENTORY_TRANS;
			}
		}
		

		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL> GetList(Expression<Func<Apps.Models.UPLOAD_INVENTORY_TRANS, bool>> where = null){
		
				IQueryable<Apps.Models.UPLOAD_INVENTORY_TRANS> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.UPLOAD_INVENTORY_TRANS, bool>> where,Expression<Func<Apps.Models.UPLOAD_INVENTORY_TRANS, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.UPLOAD_INVENTORY_TRANS> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.UPLOAD_INVENTORY_TRANS, bool>> where = null)
		{

			IQueryable<Apps.Models.UPLOAD_INVENTORY_TRANS> queryData;
		...
		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL> CreateModelList(ref IQueryable<Apps.Models.UPLOAD_INVENTORY_TRANS> queryData)
		{

			List<Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL model)
		{
				Apps.Models.UPLOAD_INVENTORY_TRANS entity = m_Rep.GetById(model.INTERFACE_RECORD_ID);
				if (entity != null)
				{
					errors.Add(Resource.PrimaryRepeat);
					return;
				}
				entity = new Apps.Models.UPLOAD_INVENTORY_TRANS();
		...
		public virtual void Modify(ref ValidationErrors errors, Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL model,params string[] updateProperties)
		{
				Apps.Models.UPLOAD_INVENTORY_TRANS entity = m_Rep.GetById(model.INTERFACE_RECORD_ID);
				if (entity == null)
				{
					...
					return;
						...
						Type type = typeof(Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL);
						Type typeE = typeof(Apps.Models.UPLOAD_INVENTORY_TRANS);
		...
		public virtual Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL GetById(string id)
		{
			Apps.Models.UPLOAD_INVENTORY_TRANS entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//UPLOAD_INVENTORY_TRANS entity = m_Rep.GetById(id);
				Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL model = new Apps.Models.SCV.UPLOAD.UPLOAD_INVENTORY_TRANS_MODEL();

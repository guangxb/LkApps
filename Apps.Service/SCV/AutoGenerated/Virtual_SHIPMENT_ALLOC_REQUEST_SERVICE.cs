...
{
	public class Virtual_SHIPMENT_ALLOC_REQUEST_SERVICE
	{
		...
		public Apps.IRepository.SCV.SHIPMENT.ISHIPMENT_ALLOC_REQUEST_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.SHIPMENT_ALLOC_REQUEST;
			}
		}
		

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_ALLOC_REQUEST_MODEL> GetList(Expression<Func<Apps.Models.SHIPMENT_ALLOC_REQUEST, bool>> where = null){
		
				IQueryable<Apps.Models.SHIPMENT_ALLOC_REQUEST> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_ALLOC_REQUEST_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.SHIPMENT_ALLOC_REQUEST, bool>> where,Expression<Func<Apps.Models.SHIPMENT_ALLOC_REQUEST, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.SHIPMENT_ALLOC_REQUEST> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_ALLOC_REQUEST_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.SHIPMENT_ALLOC_REQUEST, bool>> where = null)
		{

			IQueryable<Apps.Models.SHIPMENT_ALLOC_REQUEST> queryData;
		...
		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_ALLOC_REQUEST_MODEL> CreateModelList(ref IQueryable<Apps.Models.SHIPMENT_ALLOC_REQUEST> queryData)
		{

			List<Apps.Models.SCV.SHIPMENT.SHIPMENT_ALLOC_REQUEST_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.SHIPMENT.SHIPMENT_ALLOC_REQUEST_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.SHIPMENT.SHIPMENT_ALLOC_REQUEST_MODEL model)
		{
				...
				entity = new Apps.Models.SHIPMENT_ALLOC_REQUEST();
		...
		public virtual Apps.Models.SCV.SHIPMENT.SHIPMENT_ALLOC_REQUEST_MODEL GetById(string id)
		{
			Apps.Models.SHIPMENT_ALLOC_REQUEST entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//SHIPMENT_ALLOC_REQUEST entity = m_Rep.GetById(id);
				Apps.Models.SCV.SHIPMENT.SHIPMENT_ALLOC_REQUEST_MODEL model = new Apps.Models.SCV.SHIPMENT.SHIPMENT_ALLOC_REQUEST_MODEL();

...
{
	public class Virtual_AR_TRANSACTION_HISTORY_SERVICE
	{
		...
		public Apps.IRepository.SCV.AR.IAR_TRANSACTION_HISTORY_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.AR_TRANSACTION_HISTORY;
			}
		}
		

		public virtual List<Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL> GetList(Expression<Func<Apps.Models.AR_TRANSACTION_HISTORY, bool>> where = null){
		
				IQueryable<Apps.Models.AR_TRANSACTION_HISTORY> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.AR_TRANSACTION_HISTORY, bool>> where,Expression<Func<Apps.Models.AR_TRANSACTION_HISTORY, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.AR_TRANSACTION_HISTORY> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.AR_TRANSACTION_HISTORY, bool>> where = null)
		{

			IQueryable<Apps.Models.AR_TRANSACTION_HISTORY> queryData;
		...
		public virtual List<Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL> CreateModelList(ref IQueryable<Apps.Models.AR_TRANSACTION_HISTORY> queryData)
		{

			List<Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL model)
		{
				Apps.Models.AR_TRANSACTION_HISTORY entity = m_Rep.GetById(model.INTERNAL_ID);
				if (entity != null)
				{
					errors.Add(Resource.PrimaryRepeat);
					return;
				}
				entity = new Apps.Models.AR_TRANSACTION_HISTORY();
		...
		public virtual void Modify(ref ValidationErrors errors, Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL model,params string[] updateProperties)
		{
				Apps.Models.AR_TRANSACTION_HISTORY entity = m_Rep.GetById(model.INTERNAL_ID);
				if (entity == null)
				{
					...
					return;
						...
						Type type = typeof(Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL);
						Type typeE = typeof(Apps.Models.AR_TRANSACTION_HISTORY);
		...
		public virtual Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL GetById(string id)
		{
			Apps.Models.AR_TRANSACTION_HISTORY entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//AR_TRANSACTION_HISTORY entity = m_Rep.GetById(id);
				Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL model = new Apps.Models.SCV.AR.AR_TRANSACTION_HISTORY_MODEL();

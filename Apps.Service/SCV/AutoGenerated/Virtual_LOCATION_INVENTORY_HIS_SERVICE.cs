...
{
	public class Virtual_LOCATION_INVENTORY_HIS_SERVICE
	{
		...
		public Apps.IRepository.SCV.LOCATION.ILOCATION_INVENTORY_HIS_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.LOCATION_INVENTORY_HIS;
			}
		}
		

		public virtual List<Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_HIS_MODEL> GetList(Expression<Func<Apps.Models.LOCATION_INVENTORY_HIS, bool>> where = null){
		
				IQueryable<Apps.Models.LOCATION_INVENTORY_HIS> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_HIS_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.LOCATION_INVENTORY_HIS, bool>> where,Expression<Func<Apps.Models.LOCATION_INVENTORY_HIS, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.LOCATION_INVENTORY_HIS> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_HIS_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.LOCATION_INVENTORY_HIS, bool>> where = null)
		{

			IQueryable<Apps.Models.LOCATION_INVENTORY_HIS> queryData;
		...
		public virtual List<Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_HIS_MODEL> CreateModelList(ref IQueryable<Apps.Models.LOCATION_INVENTORY_HIS> queryData)
		{

			List<Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_HIS_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_HIS_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_HIS_MODEL model)
		{
				Apps.Models.LOCATION_INVENTORY_HIS entity = m_Rep.GetById(model.INTERNAL_LOCATION_INV);
				if (entity != null)
				{
					errors.Add(Resource.PrimaryRepeat);
					return;
				}
				entity = new Apps.Models.LOCATION_INVENTORY_HIS();
		...
		public virtual void Modify(ref ValidationErrors errors, Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_HIS_MODEL model,params string[] updateProperties)
		{
				Apps.Models.LOCATION_INVENTORY_HIS entity = m_Rep.GetById(model.INTERNAL_LOCATION_INV);
				if (entity == null)
				{
					...
					return;
						...
						Type type = typeof(Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_HIS_MODEL);
						Type typeE = typeof(Apps.Models.LOCATION_INVENTORY_HIS);
		...
		public virtual Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_HIS_MODEL GetById(string id)
		{
			Apps.Models.LOCATION_INVENTORY_HIS entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//LOCATION_INVENTORY_HIS entity = m_Rep.GetById(id);
				Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_HIS_MODEL model = new Apps.Models.SCV.LOCATION.LOCATION_INVENTORY_HIS_MODEL();

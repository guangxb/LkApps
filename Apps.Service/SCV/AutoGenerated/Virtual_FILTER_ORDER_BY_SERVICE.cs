...
{
	public class Virtual_FILTER_ORDER_BY_SERVICE
	{
		...
		public Apps.IRepository.SCV.FILTER.IFILTER_ORDER_BY_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.FILTER_ORDER_BY;
			}
		}
		

		public virtual List<Apps.Models.SCV.FILTER.FILTER_ORDER_BY_MODEL> GetList(Expression<Func<Apps.Models.FILTER_ORDER_BY, bool>> where = null){
		
				IQueryable<Apps.Models.FILTER_ORDER_BY> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.FILTER.FILTER_ORDER_BY_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.FILTER_ORDER_BY, bool>> where,Expression<Func<Apps.Models.FILTER_ORDER_BY, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.FILTER_ORDER_BY> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.FILTER.FILTER_ORDER_BY_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.FILTER_ORDER_BY, bool>> where = null)
		{

			IQueryable<Apps.Models.FILTER_ORDER_BY> queryData;
		...
		public virtual List<Apps.Models.SCV.FILTER.FILTER_ORDER_BY_MODEL> CreateModelList(ref IQueryable<Apps.Models.FILTER_ORDER_BY> queryData)
		{

			List<Apps.Models.SCV.FILTER.FILTER_ORDER_BY_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.FILTER.FILTER_ORDER_BY_MODEL
											  {
													SEQUENCE = r.SEQUENCE,

...
{
	public class Virtual_UPLOAD_SHIPPING_CONTAINER_SERVICE
	{
		...
		public Apps.IRepository.SCV.UPLOAD.IUPLOAD_SHIPPING_CONTAINER_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.UPLOAD_SHIPPING_CONTAINER;
			}
		}
		

		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_SHIPPING_CONTAINER_MODEL> GetList(Expression<Func<Apps.Models.UPLOAD_SHIPPING_CONTAINER, bool>> where = null){
		
				IQueryable<Apps.Models.UPLOAD_SHIPPING_CONTAINER> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_SHIPPING_CONTAINER_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.UPLOAD_SHIPPING_CONTAINER, bool>> where,Expression<Func<Apps.Models.UPLOAD_SHIPPING_CONTAINER, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.UPLOAD_SHIPPING_CONTAINER> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_SHIPPING_CONTAINER_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.UPLOAD_SHIPPING_CONTAINER, bool>> where = null)
		{

			IQueryable<Apps.Models.UPLOAD_SHIPPING_CONTAINER> queryData;
		...
		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_SHIPPING_CONTAINER_MODEL> CreateModelList(ref IQueryable<Apps.Models.UPLOAD_SHIPPING_CONTAINER> queryData)
		{

			List<Apps.Models.SCV.UPLOAD.UPLOAD_SHIPPING_CONTAINER_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.UPLOAD.UPLOAD_SHIPPING_CONTAINER_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.UPLOAD.UPLOAD_SHIPPING_CONTAINER_MODEL model)
		{
				Apps.Models.UPLOAD_SHIPPING_CONTAINER entity = m_Rep.GetById(model.INTERFACE_RECORD_ID);
				if (entity != null)
				{
					errors.Add(Resource.PrimaryRepeat);
					return;
				}
				entity = new Apps.Models.UPLOAD_SHIPPING_CONTAINER();
		...
		public virtual void Modify(ref ValidationErrors errors, Apps.Models.SCV.UPLOAD.UPLOAD_SHIPPING_CONTAINER_MODEL model,params string[] updateProperties)
		{
				Apps.Models.UPLOAD_SHIPPING_CONTAINER entity = m_Rep.GetById(model.INTERFACE_RECORD_ID);
				if (entity == null)
				{
					...
					return;
						...
						Type type = typeof(Apps.Models.SCV.UPLOAD.UPLOAD_SHIPPING_CONTAINER_MODEL);
						Type typeE = typeof(Apps.Models.UPLOAD_SHIPPING_CONTAINER);
		...
		public virtual Apps.Models.SCV.UPLOAD.UPLOAD_SHIPPING_CONTAINER_MODEL GetById(string id)
		{
			Apps.Models.UPLOAD_SHIPPING_CONTAINER entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//UPLOAD_SHIPPING_CONTAINER entity = m_Rep.GetById(id);
				Apps.Models.SCV.UPLOAD.UPLOAD_SHIPPING_CONTAINER_MODEL model = new Apps.Models.SCV.UPLOAD.UPLOAD_SHIPPING_CONTAINER_MODEL();

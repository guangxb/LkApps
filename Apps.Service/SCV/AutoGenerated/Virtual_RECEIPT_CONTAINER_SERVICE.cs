...
{
	public class Virtual_RECEIPT_CONTAINER_SERVICE
	{
		...
		public Apps.IRepository.SCV.RECEIPT.IRECEIPT_CONTAINER_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.RECEIPT_CONTAINER;
			}
		}
		

		public virtual List<Apps.Models.SCV.RECEIPT.RECEIPT_CONTAINER_MODEL> GetList(Expression<Func<Apps.Models.RECEIPT_CONTAINER, bool>> where = null){
		
				IQueryable<Apps.Models.RECEIPT_CONTAINER> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.RECEIPT.RECEIPT_CONTAINER_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.RECEIPT_CONTAINER, bool>> where,Expression<Func<Apps.Models.RECEIPT_CONTAINER, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.RECEIPT_CONTAINER> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.RECEIPT.RECEIPT_CONTAINER_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.RECEIPT_CONTAINER, bool>> where = null)
		{

			IQueryable<Apps.Models.RECEIPT_CONTAINER> queryData;
			...
			if (!string.IsNullOrWhiteSpace(queryStr))
			{
				queryData = m_Rep.GetList(where
								...
								|| a.RECEIVING_CART_ID.Contains(queryStr)
								|| a.RECEIVING_CART_POS.Contains(queryStr)
								);
			}else{
				queryData = m_Rep.GetList(where);
			}
		...
		public virtual List<Apps.Models.SCV.RECEIPT.RECEIPT_CONTAINER_MODEL> CreateModelList(ref IQueryable<Apps.Models.RECEIPT_CONTAINER> queryData)
		{

			List<Apps.Models.SCV.RECEIPT.RECEIPT_CONTAINER_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.RECEIPT.RECEIPT_CONTAINER_MODEL
											  {
													...
													RECEIVING_CART_ID = r.RECEIVING_CART_ID,
													RECEIVING_CART_POS = r.RECEIVING_CART_POS,
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.RECEIPT.RECEIPT_CONTAINER_MODEL model)
		{
				Apps.Models.RECEIPT_CONTAINER entity = m_Rep.GetById(model.INTERNAL_CONTAINER_NUM);
				if (entity != null)
				{
					errors.Add(Resource.PrimaryRepeat);
					return;
				}
				entity = new Apps.Models.RECEIPT_CONTAINER();
				...
				entity.RECEIVING_CART_ID = model.RECEIVING_CART_ID;
				entity.RECEIVING_CART_POS = model.RECEIVING_CART_POS;
		...
		public virtual void Modify(ref ValidationErrors errors, Apps.Models.SCV.RECEIPT.RECEIPT_CONTAINER_MODEL model,params string[] updateProperties)
		{
				Apps.Models.RECEIPT_CONTAINER entity = m_Rep.GetById(model.INTERNAL_CONTAINER_NUM);
				if (entity == null)
				{
					...
					return;
						...
						Type type = typeof(Apps.Models.SCV.RECEIPT.RECEIPT_CONTAINER_MODEL);
						Type typeE = typeof(Apps.Models.RECEIPT_CONTAINER);
		...
		public virtual Apps.Models.SCV.RECEIPT.RECEIPT_CONTAINER_MODEL GetById(string id)
		{
			Apps.Models.RECEIPT_CONTAINER entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//RECEIPT_CONTAINER entity = m_Rep.GetById(id);
				Apps.Models.SCV.RECEIPT.RECEIPT_CONTAINER_MODEL model = new Apps.Models.SCV.RECEIPT.RECEIPT_CONTAINER_MODEL();
				...
				model.RECEIVING_CART_ID = entity.RECEIVING_CART_ID;
				model.RECEIVING_CART_POS = entity.RECEIVING_CART_POS;

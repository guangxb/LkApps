...
{
	public class Virtual_SHIPMENT_HEADER_TEMP1_SERVICE
	{
		...
		public Apps.IRepository.SCV.SHIPMENT.ISHIPMENT_HEADER_TEMP1_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.SHIPMENT_HEADER_TEMP1;
			}
		}
		

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP1_MODEL> GetList(Expression<Func<Apps.Models.SHIPMENT_HEADER_TEMP1, bool>> where = null){
		
				IQueryable<Apps.Models.SHIPMENT_HEADER_TEMP1> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP1_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.SHIPMENT_HEADER_TEMP1, bool>> where,Expression<Func<Apps.Models.SHIPMENT_HEADER_TEMP1, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.SHIPMENT_HEADER_TEMP1> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP1_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.SHIPMENT_HEADER_TEMP1, bool>> where = null)
		{

			IQueryable<Apps.Models.SHIPMENT_HEADER_TEMP1> queryData;
			
			if (!string.IsNullOrWhiteSpace(queryStr))
			{
				queryData = m_Rep.GetList(where
								
								,a=>a.FLAG.Contains(queryStr)
		...
		public virtual List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP1_MODEL> CreateModelList(ref IQueryable<Apps.Models.SHIPMENT_HEADER_TEMP1> queryData)
		{

			List<Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP1_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP1_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP1_MODEL model)
		{
				Apps.Models.SHIPMENT_HEADER_TEMP1 entity = m_Rep.GetById(model.INTERNAL_SHIPMENT_NUM);
				if (entity != null)
				{
					errors.Add(Resource.PrimaryRepeat);
					return;
				}
				entity = new Apps.Models.SHIPMENT_HEADER_TEMP1();
		...
		public virtual void Modify(ref ValidationErrors errors, Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP1_MODEL model,params string[] updateProperties)
		{
				Apps.Models.SHIPMENT_HEADER_TEMP1 entity = m_Rep.GetById(model.INTERNAL_SHIPMENT_NUM);
				if (entity == null)
				{
					...
					return;
						...
						Type type = typeof(Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP1_MODEL);
						Type typeE = typeof(Apps.Models.SHIPMENT_HEADER_TEMP1);
		...
		public virtual Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP1_MODEL GetById(string id)
		{
			Apps.Models.SHIPMENT_HEADER_TEMP1 entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//SHIPMENT_HEADER_TEMP1 entity = m_Rep.GetById(id);
				Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP1_MODEL model = new Apps.Models.SCV.SHIPMENT.SHIPMENT_HEADER_TEMP1_MODEL();

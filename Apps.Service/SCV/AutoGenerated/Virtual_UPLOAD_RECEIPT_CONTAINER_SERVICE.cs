...
{
	public class Virtual_UPLOAD_RECEIPT_CONTAINER_SERVICE
	{
		...
		public Apps.IRepository.SCV.UPLOAD.IUPLOAD_RECEIPT_CONTAINER_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.UPLOAD_RECEIPT_CONTAINER;
			}
		}
		

		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_CONTAINER_MODEL> GetList(Expression<Func<Apps.Models.UPLOAD_RECEIPT_CONTAINER, bool>> where = null){
		
				IQueryable<Apps.Models.UPLOAD_RECEIPT_CONTAINER> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_CONTAINER_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.UPLOAD_RECEIPT_CONTAINER, bool>> where,Expression<Func<Apps.Models.UPLOAD_RECEIPT_CONTAINER, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.UPLOAD_RECEIPT_CONTAINER> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_CONTAINER_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.UPLOAD_RECEIPT_CONTAINER, bool>> where = null)
		{

			IQueryable<Apps.Models.UPLOAD_RECEIPT_CONTAINER> queryData;
		...
		public virtual List<Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_CONTAINER_MODEL> CreateModelList(ref IQueryable<Apps.Models.UPLOAD_RECEIPT_CONTAINER> queryData)
		{

			List<Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_CONTAINER_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_CONTAINER_MODEL
											  {
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_CONTAINER_MODEL model)
		{
				...
				entity = new Apps.Models.UPLOAD_RECEIPT_CONTAINER();
		...
		public virtual Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_CONTAINER_MODEL GetById(string id)
		{
			Apps.Models.UPLOAD_RECEIPT_CONTAINER entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//UPLOAD_RECEIPT_CONTAINER entity = m_Rep.GetById(id);
				Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_CONTAINER_MODEL model = new Apps.Models.SCV.UPLOAD.UPLOAD_RECEIPT_CONTAINER_MODEL();

...
namespace Apps.Service.SCV.CONSOLIDATE
{
	public class Virtual_CONSOLIDATE_SHIPMENT_HEADER_SERVICE
	{
		...
		public Apps.IRepository.SCV.CONSOLIDATE.ICONSOLIDATE_SHIPMENT_HEADER_REPOSITORY m_Rep{
			 get
			{
				return SCVDBSession.CONSOLIDATE_SHIPMENT_HEADER;
			}
		}
		

		public virtual List<Apps.Models.SCV.CONSOLIDATE.CONSOLIDATE_SHIPMENT_HEADER_MODEL> GetList(Expression<Func<Apps.Models.CONSOLIDATE_SHIPMENT_HEADER, bool>> where = null){
		
				IQueryable<Apps.Models.CONSOLIDATE_SHIPMENT_HEADER> queryData = m_Rep.GetList(where);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.CONSOLIDATE.CONSOLIDATE_SHIPMENT_HEADER_MODEL> GetListSort<TKey>(Expression<Func<Apps.Models.CONSOLIDATE_SHIPMENT_HEADER, bool>> where,Expression<Func<Apps.Models.CONSOLIDATE_SHIPMENT_HEADER, TKey>>orderBy, bool isAsc = true){
		
				IQueryable<Apps.Models.CONSOLIDATE_SHIPMENT_HEADER> queryData = m_Rep.GetListSort(where, orderBy, isAsc);
				return CreateModelList(ref queryData);
		}

		public virtual List<Apps.Models.SCV.CONSOLIDATE.CONSOLIDATE_SHIPMENT_HEADER_MODEL> GetList(ref GridPager pager, string queryStr,Expression<Func<Apps.Models.CONSOLIDATE_SHIPMENT_HEADER, bool>> where = null)
		{

			IQueryable<Apps.Models.CONSOLIDATE_SHIPMENT_HEADER> queryData;
			...
			if (!string.IsNullOrWhiteSpace(queryStr))
			{
				queryData = m_Rep.GetList(where
								...
								|| a.SIGN_VALUE2.Contains(queryStr)
								|| a.SIGN_VALUE3.Contains(queryStr)
								|| a.SIGN_VALUE4.Contains(queryStr)
		...
		public virtual List<Apps.Models.SCV.CONSOLIDATE.CONSOLIDATE_SHIPMENT_HEADER_MODEL> CreateModelList(ref IQueryable<Apps.Models.CONSOLIDATE_SHIPMENT_HEADER> queryData)
		{

			List<Apps.Models.SCV.CONSOLIDATE.CONSOLIDATE_SHIPMENT_HEADER_MODEL> modelList = (from r in queryData
											  select new Apps.Models.SCV.CONSOLIDATE.CONSOLIDATE_SHIPMENT_HEADER_MODEL
											  {
													...
													SIGN_VALUE2 = r.SIGN_VALUE2,
													SIGN_VALUE3 = r.SIGN_VALUE3,
													SIGN_VALUE4 = r.SIGN_VALUE4,
													CONSOLIDATE_DATE_TIME = r.CONSOLIDATE_DATE_TIME,
		...
		public virtual void Create(ref ValidationErrors errors, Apps.Models.SCV.CONSOLIDATE.CONSOLIDATE_SHIPMENT_HEADER_MODEL model)
		{
				Apps.Models.CONSOLIDATE_SHIPMENT_HEADER entity = m_Rep.GetById(model.INTERNAL_NUM);
				if (entity != null)
				{
					errors.Add(Resource.PrimaryRepeat);
					return;
				}
				entity = new Apps.Models.CONSOLIDATE_SHIPMENT_HEADER();
				...
				entity.SIGN_VALUE2 = model.SIGN_VALUE2;
				entity.SIGN_VALUE3 = model.SIGN_VALUE3;
				entity.SIGN_VALUE4 = model.SIGN_VALUE4;
				entity.CONSOLIDATE_DATE_TIME = model.CONSOLIDATE_DATE_TIME;
		...
		public virtual void Modify(ref ValidationErrors errors, Apps.Models.SCV.CONSOLIDATE.CONSOLIDATE_SHIPMENT_HEADER_MODEL model,params string[] updateProperties)
		{
				Apps.Models.CONSOLIDATE_SHIPMENT_HEADER entity = m_Rep.GetById(model.INTERNAL_NUM);
				if (entity == null)
				{
					...
					return;
						...
						Type type = typeof(Apps.Models.SCV.CONSOLIDATE.CONSOLIDATE_SHIPMENT_HEADER_MODEL);
						Type typeE = typeof(Apps.Models.CONSOLIDATE_SHIPMENT_HEADER);
		...
		public virtual Apps.Models.SCV.CONSOLIDATE.CONSOLIDATE_SHIPMENT_HEADER_MODEL GetById(string id)
		{
			Apps.Models.CONSOLIDATE_SHIPMENT_HEADER entity = m_Rep.GetById(id);
			if (entity!=null)
			{
				//CONSOLIDATE_SHIPMENT_HEADER entity = m_Rep.GetById(id);
				Apps.Models.SCV.CONSOLIDATE.CONSOLIDATE_SHIPMENT_HEADER_MODEL model = new Apps.Models.SCV.CONSOLIDATE.CONSOLIDATE_SHIPMENT_HEADER_MODEL();
				...
				model.SIGN_VALUE2 = entity.SIGN_VALUE2;
				model.SIGN_VALUE3 = entity.SIGN_VALUE3;
				model.SIGN_VALUE4 = entity.SIGN_VALUE4;
				model.CONSOLIDATE_DATE_TIME = entity.CONSOLIDATE_DATE_TIME;

    ...
    public class AdoJobStoreRunner : IQuartzRunner
    {
        ...
        public virtual IScheduler Run(bool clearJobs, bool schedulerJobs)
        {
            ...
            if (schedulerJobs)
            {
                ...
                ITrigger trigger1 = TriggerBuilder.Create().WithIdentity("trigger_QiMenStockoutConfirm", schedulerId).StartNow().WithCronSchedule("0 0/12 * * * ?").Build();
                ...
                ITrigger trigger3 = TriggerBuilder.Create().WithIdentity("trigger_QiMenReturnorderConfirm", schedulerId).StartNow().WithCronSchedule("0 0/12 * * * ?").Build();
